...
class App {
  constructor(container, { items, bend = 3, textColor = '#ffffff', borderRadius = 0, font = 'bold 30px Figtree', scrollSpeed = 2, scrollEase = 0.05 } = {}) {
...
export default function Carrusel({
  ...
  useEffect(() => {
    const fontSize = window.innerWidth < 768 ? '20px' : '30px';
    appRef.current = new App(containerRef.current, { items, bend, textColor, borderRadius, font: `bold ${fontSize}px Figtree` });
  ...
  return (
    <div style={{ position: 'relative' }}>
      <div style={{ height: '60vh', maxHeight: '600px', width: '100%' }} ref={containerRef} />
        ...
        {items.map((_, idx) => (
          <button
            ...
            style={{
              padding: '5px 10px',
              borderRadius: '5px',
              backgroundColor: idx === currentSlide ? '#fff' : '#555',
              color: idx === currentSlide ? '#000' : '#fff',
              border: 'none',
              cursor: 'pointer',
            }}
          >
